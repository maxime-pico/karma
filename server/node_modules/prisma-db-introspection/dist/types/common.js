...
var Table = /** @class */ (function () {
    ...
    Table.prototype.hasPrimaryKey = function () {
        return this.columns.some(function (x) { return x.isPrimaryKey; });
    };
    Table.prototype.isJoinTable = function () {
        ...
        var condition3 = !this.columns.filter(function (c) { return !_this.isRelationColumn(c) !== null; }).some(function (c) { return !c.nullable && (c.defaultValue === null); });
