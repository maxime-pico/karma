...
var PostgresConnector = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), relations = _a[0], tableColumns = _a[1], primaryKeys = _a[2];
    ...
    PostgresConnector.prototype.queryPrimaryKeys = function (schemaName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.query("SELECT tc.table_name, kc.column_name\n       FROM information_schema.table_constraints tc\n       JOIN information_schema.key_column_usage kc \n         ON kc.table_name = tc.table_name \n         AND kc.table_schema = tc.table_schema\n         AND kc.constraint_name = tc.constraint_name\n       WHERE tc.constraint_type = 'PRIMARY KEY'\n       AND tc.table_schema = $1::text\n       AND kc.ordinal_position IS NOT NULL\n       ORDER BY tc.table_name, kc.position_in_unique_constraint;", [schemaName.toLowerCase()]).then(function (keys) {
