...
var TypescriptGenerator = /** @class */ (function (_super) {
    ...
    TypescriptGenerator.prototype.renderFieldType = function (_a) {
        var field = _a.field, node = _a.node, input = _a.input, partial = _a.partial, renderFunction = _a.renderFunction, _b = _a.isMutation, isMutation = _b === void 0 ? false : _b, _c = _a.isSubscription, isSubscription = _c === void 0 ? false : _c;
        var type = field.type;
        var deepType = this.getDeepType(type);
