...
var TypeFromModelGenerator = /** @class */ (function (_super) {
     ...
     * @param fields
     */
    TypeFromModelGenerator.hasUniqueField = function (fields) {
     ...
     * @param fieldNames
     */
    TypeFromModelGenerator.hasFieldsExcept = function (fields) {
        var fieldNames = [];
    ...
    TypeFromModelGenerator.reservedFields = ['id', 'createdAt', 'updatedAt'];
