...
var Delete = /** @class */ (function (_super) {
    ...
    Delete.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var force, envFile, serviceName, workspaceName, stage, cluster, prettyName, before;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        workspaceName = this.definition.getWorkspace();
                    ...
                    case 2:
                        _a.sent();
                        prettyName = chalk_1.default.bold(serviceName) + "@" + stage;
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.client.deleteProject(serviceName, stage, this.definition.getWorkspace() || this.env.activeCluster.workspaceSlug)];
                    case 5:
                        _a.sent();
