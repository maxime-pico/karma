...
var EndpointDialog = /** @class */ (function () {
    ...
    EndpointDialog.prototype.handleChoice = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var clusterEndpoint, cluster, workspace, service, stage, credentials, dockerComposeYml, datamodel, newDatabase, managementSecret, writeDockerComposeYml, _c, needsAuth, type, _d, before, connector, introspector, schemas, e_1, _e, numTables, sdl, demoCluster, result_1, _f, _g;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 13:
                        ...
                        connector = new prisma_db_introspection_1.PostgresConnector(this.replaceLocalDockerHost(credentials));
                    ...
                    case 17:
                        ...
                        return [4 /*yield*/, introspector.introspect(credentials.schema || schemas[0])];
                    case 18:
